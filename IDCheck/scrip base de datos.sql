...
CREATE TABLE IF NOT EXISTS `ID_Check_DB`.`TipoPersonal` (
  `idTipoPersonal` CHAR(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ID_Check_DB`.`Acceso` (
  ...
  `Essalud` TINYINT(1) NULL,
  `sctrSalud` TINYINT(1) NULL,
  `sctrPensiones` TINYINT(1) NULL,
  `pdtplame` TINYINT(1) NULL,
  `afp` TINYINT(1) NULL,
  `onp` TINYINT(1) NULL,
  `idArea` CHAR(4) NULL,
  `idTipoPersonal` CHAR(4) NULL,
  `idEmpresaColaboradora` CHAR(11) NULL,
  INDEX `fk_Acceso_Personal1_idx` (`idPersonal` ASC),
  INDEX `fk_Acceso_Area1_idx` (`idArea` ASC),
  INDEX `fk_Acceso_TipoPersonal1_idx` (`idTipoPersonal` ASC),
  PRIMARY KEY (`idPersonal`),
  ...
  CONSTRAINT `fk_Acceso_Area1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Acceso_TipoPersonal1`
...
CREATE TABLE IF NOT EXISTS `ID_Check_DB`.`Registro` (
  ...
  CONSTRAINT `fk_Registro_Acceso1`
    ...
    REFERENCES `ID_Check_DB`.`Acceso` (`idPersonal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `ID_Check_DB`;
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('44535858', 'Honorina', 'Muñoz Molina', '1972-05-20', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10226219', 'Marilyn Marlene', 'Arratia Rivas', '1972-05-21', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10226093', 'Francisco Segundo', 'Ascencio Vera', '1972-05-22', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09954108', 'Susana Angela', 'Mora Soutullo', '1972-05-23', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('07523648', 'Bernarda del Carmen', 'Fonseca', '1972-05-24', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09532601', 'Segundo Ramón', 'Paz Zambrano', '1972-05-25', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('08036799', 'Flor Esilda', 'Bustos Riffo', '1972-05-26', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10305236', 'Cecilia', 'Gallardo Tapia', '1972-05-27', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10706891', 'Samuel Segundo', 'Alarcón Valdebenito', '1972-05-28', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09159894', 'Sonia Inés', 'Leal Leal', '1972-05-29', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('43087580', 'Lucila', 'Aravena Hernandez', '1972-05-30', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('40556643', 'Juan', 'Carrasco Vega', '1972-05-31', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('46784633', 'Maritza', 'Lagos Oliva', '1972-06-01', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09952776', 'Irma Eliana', 'Recabal Silva', '1972-06-02', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('08945926', 'José', 'Medina Cisternas', '1972-06-03', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('44061233', 'Rosa Eulalia', 'Vera Meli', '1972-06-04', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09144433', 'Flilomena del Carmen', 'Loyola Cortéz', '1972-06-05', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10595907', 'Juan', 'Ramos Peña', '1972-06-06', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('08898576', 'Edita', 'Salgado Ortiz', '1972-06-07', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('42388482', 'Rosa Elena', 'Romero benavente', '1972-06-08', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('41009386', 'Ema del Carmen', 'Rocha saez', '1972-06-09', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10515671', 'María Angélica', 'Martinez Aravena', '1972-06-10', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('22707420', 'Heraldo', 'Cuevas Orellana', '1972-06-11', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09284554', 'Sergio', 'Ibañez Torres', '1972-06-12', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('04071357', 'Moises', 'Alarcón salazar', '1972-06-13', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('41131292', 'Graciela', 'Salazar Hermosilla', '1972-06-14', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09596483', 'José Maria', 'fierro Muñoz', '1972-06-15', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('40263189', 'Magaly del Pilar', 'Rivera Retamal', '1972-06-16', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('07484492', 'Hilda Ester', 'Contreras Pincheira', '1972-06-17', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('07690102', 'Juan Honorino', 'Fredes Carrillo', '1972-06-18', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('44229519', 'Leonardo Manuel', 'Carrasco Palma', '1972-06-19', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('06946954', 'Marta', 'Faundez Baeza', '1972-06-20', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('42403620', 'Alejandra del Carmen', 'Contreras Rodriguez', '1972-06-21', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('42722920', 'Tania Angelica', 'Villar Cariaga', '1972-06-22', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10593824', 'Irene del Carmen', 'Aguilera Rivera', '1972-06-23', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('45833457', 'Estela de Las Mercedes', 'Zapata Arriagada', '1972-06-24', NULL, 'peon');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('09586145', 'Roguers Alberto', 'Morales Navarrete', '1972-06-25', NULL, 'operador');
INSERT INTO `ID_Check_DB`.`Personal` (`idPersonal`, `Nombres`, `Apellidos`, `FechaNac`, `Foto`, `Cargo`) VALUES ('10754417', 'Maria margarita', 'Fuentealba vallejos', '1972-06-26', NULL, 'peon');
