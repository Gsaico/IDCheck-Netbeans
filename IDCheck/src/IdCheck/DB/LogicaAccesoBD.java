...
public class LogicaAccesoBD {
    ...
    public LogicaAcceso VerificarAutorizacion() throws ClassNotFoundException,
        ...
        cdb.un_sql = "SELECT IF (date(now()) BETWEEN t1.FechaDesde AND t1.FechaHasta, 'SI','NO') AS Autorizacion,    t2.Apellidos, t2.Nombres, t1.idpersonal AS DNI, " +
...
"WHERE  T1.idpersonal = '"+ clsLogicaAcceso.getIdacceso() +"'";
        ...
        if (cdb.resultado != null) {
            if (cdb.resultado.next()) {
                clsLogicaAcceso.setAutorizacion(cdb.resultado.getString("Autorizacion"));
